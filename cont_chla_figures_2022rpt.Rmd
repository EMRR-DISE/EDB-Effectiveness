---
title: "EDB: Continuous Chlorophyll Figures - 2022 Report"
...
i_am("cont_chla_figures_2022rpt.Rmd")
```
...
df_d_chla_orig <- read_csv(here("data/d_chla_fal_osj_d19.csv"))
```
...
ggsave(
  here("figures/cont_chla_ts_daily_avg_2022rpt.jpg"),
  plot = plt_ts_avg,
  width = 6.5,
  height = 8.25,
  units = "in"
...
ggsave(
  here("figures/cont_chla_ts_daily_med_2022rpt.jpg"),
  plot = plt_ts_med,
  width = 6.5,
  height = 8.25,
  units = "in"
...
ggsave(
  here("figures/cont_d_chla_ts_comp_2022rpt.jpg"),
  plot = plt_ts_d_cont,
  width = 4.5,
  height = 5,
  units = "in"
...
ggsave(
  here("figures/cont_chla_bp_season_2022rpt.jpg"),
  plot = plt_bp_seas,
  width = 6.5,
  height = 4,
  units = "in"
...
ggsave(
  here("figures/cont_chla_bp_yr_2022rpt.jpg"),
  plot = plt_bp_yr,
  width = 5,
  height = 4,
  units = "in"
