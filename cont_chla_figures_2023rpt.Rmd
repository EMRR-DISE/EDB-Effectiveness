...
Create some time-series and boxplot figures of the daily averages and medians of the continuous chlorophyll data for 2020-2022 for the **April 2023** Emergency Drought Barrier report.
...
df_cont_chla_c <- df_cont_chla  %>% 
  mutate(
    ...
    Region = if_else(Station == "FAL", "Central Delta", Region),
...
ggsave(
  here("figures/cont_chla_ts_daily_avg_2023rpt.jpg"),
  plot = plt_ts_avg,
  width = 10,
  height = 8,
  units = "in"
...
ggsave(
  here("figures/cont_chla_ts_daily_med_2023rpt.jpg"),
  plot = plt_ts_med,
  width = 10,
  height = 8,
  units = "in"
...
ggsave(
  here("figures/cont_chla_bp_season_2023rpt.jpg"),
  plot = plt_bp_seas,
  width = 7,
  height = 4.5,
  units = "in"
...
ggsave(
  here("figures/cont_chla_bp_yr_2023rpt.jpg"),
  plot = plt_bp_yr,
  width = 5.5,
  height = 4.5,
  units = "in"
